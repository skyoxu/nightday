...
Title: nightday - vertical slice RPG foundation
Status: Active
ADR-Refs:
  - ADR-0018
  - ADR-0004
...
# PRD-NEWGUILD-VS-0001: First Vertical Slice - RPG Foundation
...
### 1.2 目标
Define the first playable vertical slice for nightday: an RPG foundation centered on party progression, quests, and core loop validation.
